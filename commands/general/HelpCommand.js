...
import { ActionRowBuilder, ApplicationCommandOptionType, ComponentType, StringSelectMenuBuilder } from "discord.js";
export let HelpCommand = class HelpCommand extends BaseCommand {
    ...
    constructor(...args){
        ...
        _define_property(this, "infoEmbed", createEmbed("info").setThumbnail("https://cdn.clytage.org/images/question_mark.png"));
    }
};
HelpCommand = _ts_decorate([
    Command({
        aliases: [
            "h",
            "command",
